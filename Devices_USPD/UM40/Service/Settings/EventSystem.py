...
class SettingsEventSystem:
    ...
    def _Generate_Calendar(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Events_Calendar import Calendar
    ...
    def _Generate_Scheduler(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Events_Scheduler import Schedule
    ...
    def _Generate_Manager(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Events_Manager import EventManager
    ...
    def _Generate_TemplatesMeter(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Templates_Meter import TemplatesMeter
    ...
    def _Generate_TemplatesMeterData(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Templates_MeterData import TemplatesMeterData
    ...
    def _Generate_Messages(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Templates_Messages import TemplatesMessages
    ...
    def _Generate_Email(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Templates_Email import TemplatesEmail
    ...
    def _Generate_MeterPoller(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Actions_MeterPoller import MeterPoller
    ...
    def _Generate_SMTP(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Actions_SMPT import ActionsSMTP
    ...
    def _Generate_SNTP(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Actions_SNTP import ActionsSNTP
    ...
    def _Generate_MQTT(self):
        from Devices_USPD.UM40.Functional.Settings.EventSystem.Actions_MQTT import ActionsMQTT

...
class DeviceSettings:
    ...
    def _Generate_Ethernet(self):
        from Devices_USPD.UM40.Functional.Settings.DeviceSettings.Interface_Ethernet import Interface_Ethernet
    ...
    def _Generate_UART(self):
        from Devices_USPD.UM40.Functional.Settings.DeviceSettings.Interface_UART import Interface_UART
    ...
    def _Generate_DOut(self):
        from Devices_USPD.UM40.Functional.Settings.DeviceSettings.Interface_DOut import Interface_DOut_PowerLine
    ...
    def _Generate_Time_Local(self):
        from Devices_USPD.UM40.Functional.Settings.DeviceSettings.Local_Time import TimeZone

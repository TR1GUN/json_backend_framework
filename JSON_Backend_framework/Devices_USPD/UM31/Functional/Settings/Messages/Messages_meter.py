...
from JSON_Backend_framework.Service.Template_Devices_Functions.Settings.Messages.Template_Messages_meter_settings import \
    TemplateMessagesMeter


# -------------------------------------------------------------------------------------------------------------
class MessagesMeter(TemplateMessagesMeter):
    """
    Сообщения с данными приборов учета
    """

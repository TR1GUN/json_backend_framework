...
class UM_31_SMART_UpLoad(Template_UM_XX_SMART_Actions):
    ...
    def _Upload_Firmware(self):
        ...
        Загрузка файлов обновления ВПО
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Upload.Upload_Firmware import  UpLoadFirmware
    ...
    def _Upload_Loader(self):
        ...
        Загрузка файлов обновления загрузчика
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Upload.Upload_Loader import UpLoadLoader

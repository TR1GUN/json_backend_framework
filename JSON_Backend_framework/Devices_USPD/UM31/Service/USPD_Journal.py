...
class UM_31_SMART_Journal(Template_UM_XX_SMART_Journal):
    ...
    # # Журнал системы событий - Вырезано
    # def _Journal_Action(self):
    #     """
    #     Журнал системы событий
    #     """
    #     from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Action import JournalAction
    ...
    def _Journal_Time(self):
        ...
        Журнал изменения времени
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Time import JournalTime
        Time = JournalTime(
            cookies=self._cookies,
            headers=self._headers,
            ip_address=self._ip_address
    ...
    def _Journal_ServerConnect(self):
        ...
        Журнал сетевых подключений
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_ServerConnect import JournalServerConnect
    ...
    def _Journal_PPP_ClientConnect(self):
        ...
        Журнал PPP подключений - Клиент
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_PPP_ClientConnect import JournalPPPClientConnect
    ...
    def _Journal_PPP_ServerConnect(self):
        ...
        Журнал PPP подключений - Сервер
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_PPP_ServerConnect import JournalPPPServerConnect
    ...
    def _Journal_Call(self):
        ...
        Журнал входящих вызовов (CSD)
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Call import JournalCall
        Call = JournalCall(
            cookies=self._cookies,
            headers=self._headers,
            ip_address=self._ip_address
    ...
    def _Journal_DIn_Sens(self):
        ...
        Журнал изменения состояния дискретных входов
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_DIn_Sens import JournalDInSens
    ...
    def _Journal_DIn_PowerLine(self):
        ...
        Журнал изменения состояния дискретных входов
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_DIn_PowerLine import JournalDInPowerLine
    ...
    def _Journal_DIn_Power(self):
        ...
        Журнал изменения состояния дискретных входов
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_DIn_Power import JournalDInPower
    ...
    def _Journal_DIn_Charge(self):
        ...
        Журнал изменения состояния дискретных входов
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_DIn_Charge import JournalDInCharge
    ...
    def _Journal_DIn_Open(self):
        ...
        Журнал изменения состояния дискретных входов
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_DIn_Open import JournalDInOpen
    ...
    def _Journal_Auth_JSON(self):
        ...
        Журнал авторизации
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Auth_JSON import JournalAuthJSON
    ...
    def _Journal_Reset(self):
        ...
        Журнал перезагрузок
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Reset import JournalReset
        Reset = JournalReset(
            cookies=self._cookies,
            headers=self._headers,
            ip_address=self._ip_address
    ...
    def _Journal_Mail_Message(self):
        ...
        Журнал хранилища почтовых сообщений
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Mail_Message import JournalMailMessage
    ...
    def _Journal_Mail_Send(self):
        ...
        Журнал отправки почтовых сообщений
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Mail_Send import JournalMailSend
    ...
    def _Journal_Update_Version(self):
        ...
        Журнал изменения версии ВПО изделия
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Update_Version import JournalUpdateVersion
    ...
    def _Journal_Update_Loader(self):
        ...
        Журнал обновления ВПО загрузчика
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Update_Loader import JournalUpdateLoader
    ...
    def _Journal_Meter_Answer(self):
        ...
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_Meter_Answer import JournalMeterAnswer
    ...
    def _Journal_SMS_Message(self):
        ...
        Журнал хранилища исходящих SMS сообщений
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_SMS_Message import JournalSMSMessage
    ...
    def _Journal_SMS_Send(self):
        ...
        Журнал отправки SMS
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_SMS_Send import JournalSMSSend
    ...
    def _Journal_SMS_Get(self):
        ...
        Журнал приема SMS
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_SMS_Get import JournalSMSGet
    ...
    def _Journal_MQTT_Connect(self):
        ...
        Журнал установки связи с MQTT-брокером
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_MQTT_Connect import JournalMQTTConnect
    ...
    def _Journal_MQTT_Message(self):
        ...
        Журнал обмена сообщениями с MQTT-брокером
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Journal.Journal_MQTT_Message import JournalMQTTMessage

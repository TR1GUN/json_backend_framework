...
class UM_31_SMART_Actions(Template_UM_XX_SMART_Actions):
    ...
    def _Actions_Restart(self):
        ...
        Перезагрузка
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Action.Action_Device_Restart import ActionDeviceRestart
    ...
    def _Actions_Time_Set(self):
        ...
        Установка времени – Системное время устройства
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Action.Action_Time_Set import ActionTimeSet
    ...
    def _Actions_Time_Sync(self):
        ...
        Синхронизация времени (SNTP)
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Action.Action_Time_Sync import ActionTimeSync
    ...
    def _Actions_Time_Check(self):
        ...
        Поверка внешних ЧРВ
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Action.Action_Time_Check import ActionTimeCheck
    ...
    def _Actions_Update_Loader(self):
        ...
        Обновление загрузчика
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Action.Action_Update_Loader import ActionLoaderUpdate
    ...
    def _Actions_Disk_Clear(self):
        ...
        Очистка логического диска
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Action.Action_Disk_Clear import ActionDiskClear
    ...
    def _Actions_Storage_Sync(self):
        ...
        Синхронизация хранилища данных приборов учета
        """
        from JSON_Backend_framework.Devices_USPD.UM31.Functional.Action.Action_Storage_Sync import ActionStorageSync

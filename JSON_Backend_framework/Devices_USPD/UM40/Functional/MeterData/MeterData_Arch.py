...
from JSON_Backend_framework.Service.Template_Devices_Functions.MeterData.Template_Meter_Data_arch import TemplateMeterDataArch , TemplateMeterDataArch_Read_Measure
...
# -------------------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------------------
class MeterDataArch_Electric(TemplateMeterDataArch_Read_Measure):
    """
    Чтение значений Электросчетчиков
    """
...
class MeterDataArch_MeasureRead:
    """
    Чтение Данных счетчиков
    ...
    def _define_functional(self):
        ...
        self.Journal = MeterDataArch_Journal(cookies=self._cookies, headers=self._headers, ip_address=self._ip_address)
        self.Digital = MeterDataArch_Digital(cookies=self._cookies, headers=self._headers, ip_address=self._ip_address)
        self.Pulse = MeterDataArch_Pulse(cookies=self._cookies, headers=self._headers, ip_address=self._ip_address)
        self.Electric = MeterDataArch_Electric(cookies=self._cookies, headers=self._headers, ip_address=self._ip_address)
...
class MeterDataArch(TemplateMeterDataArch):
    ...
    def __init__(self, cookies=None, headers=None, ip_address=None):
        ...
        self.Measures = MeterDataArch_MeasureRead(cookies=cookies, headers=headers, ip_address=ip_address)

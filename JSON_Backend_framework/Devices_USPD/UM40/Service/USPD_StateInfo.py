...
class UM_40_SMART_StateInfo(Template_UM_XX_SMART_State):
    ...
    def _State_DOut(self):
        ...
        :return:
        """
        from JSON_Backend_framework.Devices_USPD.UM40.Functional.InfoState.State_DOut import StateDOut
        DOut = StateDOut(
    ...
    #     :return:
    #     """
    #     from JSON_Backend_framework.Devices_USPD.UM40.Functional.InfoState.State_Network import StateNetwork
    ...
    #     :return:
    #     """
    #     from JSON_Backend_framework.Devices_USPD.UM40.Functional.InfoState.State_Socket import StateSocket
    #     Socket = StateSocket(
    #         cookies=self._cookies,
    #         headers=self._headers,
    #         ip_address=self._ip_address
    ...
    def _State_Time(self):
        ...
        :return:
        """
        from JSON_Backend_framework.Devices_USPD.UM40.Functional.InfoState.State_Time import StateTime
        Time = StateTime(
            cookies=self._cookies,
            headers=self._headers,
            ip_address=self._ip_address
    ...
    def _State_System(self):
        ...
        from JSON_Backend_framework.Devices_USPD.UM40.Functional.InfoState.State_System import StateSystem
        System = StateSystem(
            cookies=self._cookies,
            headers=self._headers,
            ip_address=self._ip_address

...
class SettingsModem:
    ...
    #     :return:
    #     """
    #     from JSON_Backend_framework.Devices_USPD.UM40.Functional.Settings.Modem.Modem_SIM import ModemSIM
    #     SIM_card = ModemSIM(
    #         cookies=self._cookies,
    #         headers=self._headers,
    #         ip_address=self._ip_address
    ...
    #     :return:
    #     """
    #     from JSON_Backend_framework.Devices_USPD.UM40.Functional.Settings.Modem.Modem_CSD import ModemCSD
    #     CSD = ModemCSD(
    #         cookies=self._cookies,
    #         headers=self._headers,
    #         ip_address=self._ip_address
    ...
    #     """
    #
    #     from JSON_Backend_framework.Devices_USPD.UM40.Functional.Settings.Modem.Modem_APN import ModemAPN
    #     APN = ModemAPN(
    #         cookies=self._cookies,
    #         headers=self._headers,
    #         ip_address=self._ip_address

...
class UM_40_SMART_Actions(Template_UM_XX_SMART_Actions):
    ...
    def _Actions_Set_Time(self):
        ...
        """
        from JSON_Backend_framework.Devices_USPD.UM40.Functional.Action.Action_Time_Set import SetTime
        Time = SetTime(
    ...
    def _Actions_Restart(self):
        ...
        """
        from JSON_Backend_framework.Devices_USPD.UM40.Functional.Action.Action_Device_Restart import DeviceRestart

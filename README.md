...
```
Поскольку необходима авторизация, поэтому необходимо задавать 3 параметра:
- Login - `str` - Логин
- Password - `str` - Пароль
- ip_address - `str` - IP адрес УСПД

Если он не задан, то ищется файл `settings.ini`, после читается и берутся значения от туда
...
- MeterDevices - Опрос Приборов Учета \ Управление приборами Учета
...
-----------
#### uart	Настройки последовательных интерфейсов(UART)

-----------
#### din	Настройки дискретных входов

-----------
#### dout	Настройки линий питания интерфейсов
...
-----------
#### name	Настройки имени устройства

-----------

#### modem	Настройки модема

-----------
### Настройки отдельных категорий 

Здесь приведены настройки, которые имеют свое отдельное поле класса

-----------
### Proto
Настройки связанные с протоколами обмена

-----------
### Time
Настройки связанные с временем
...
Добавление своих элементов массива по-одному     
В классе есть поле `SettingsSim` через который можно добавлять свои настройки для использования в основном классе.   
Это поле является объектом класса со своими методами.   
Методы Класса:   
...
-----------
### Messages
Настройки связанные с Обменом сообщений
...
-----------
### Events
Настройки связанные с системой событий

-----------
### Actions
Настройки связанные с действиями
